...
tags:
  ...
  - 組み込みLinux
private: true
updated_at: '2026-02-13T17:14:06+09:00'
...
|------|------------------------|-------------------|
| 目的 | 差分更新・迅速対応 | 初期状態構築 |
| ビルド環境 | Docker | submodule構成 |
| 出力形式 | ipkパッケージ | SDイメージ |
| 配布方法 | クラウド経由 | SDカード |
| 影響範囲 | 更新対象コンポーネントのみ | 全レイヤ |
...
Shizen Box の開発環境は、その問いに対する組み込みLinux開発における一般的な現実解だと考えています。
